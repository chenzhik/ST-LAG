...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    @classmethod
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None, model_name=None, unet_additional_kwargs=None):
        ...
        model_name = SAFETENSORS_WEIGHTS_NAME if model_name == None else "diffusion_pytorch_model.fp16.bin"
        model_file = os.path.join(pretrained_model_path, model_name) 
